...
void Login::Init()
{
    ...
    m_loginTitle.setPosition(m_context->m_window->getSize().x / 2 - 250.f,
                             m_context->m_window->getSize().y / 2 - 530.f);
    m_loginTitle.setCharacterSize(84);
    // Buttons
   ...
   // m_pwd.setFillColor(sf::Color::Black);
    ...
    m_pwd.setPosition(m_context->m_window->getSize().x / 2 - 140.f,
                           m_context->m_window->getSize().y / 2 - 20.f);
    m_pwd.setCharacterSize(64);
    // Textboxes
